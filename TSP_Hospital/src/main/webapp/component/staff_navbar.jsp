...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
  <div class="container-fluid"> 
    <a class="navbar-brand" href="index.jsp"><i class="fa-solid fa-house-medical fa-bounce"></i> TSP Hospital</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <c:if test="${empty staffObj }">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="viewApp.jsp">View Appointment</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="complaints.jsp">Complaints</a>
        </li>
         <li class="nav-item">
